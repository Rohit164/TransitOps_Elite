...
router.route('/')
    .get((0, rbac_middleware_js_1.restrictTo)(client_1.Role.FLEET_MANAGER, client_1.Role.DRIVER, client_1.Role.FINANCIAL_ANALYST), maintenance_controller_js_1.getAllMaintenance)
